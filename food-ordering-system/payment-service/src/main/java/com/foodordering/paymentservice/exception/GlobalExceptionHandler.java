...
public class GlobalExceptionHandler {
    ...
    private String mergeValidationMessages(String first, String second) {
        if (isRequiredMessage(second) && !isRequiredMessage(first)) {
            return second;
        }
    ...
    private boolean isRequiredMessage(String message) {
        return message.toLowerCase(Locale.ROOT).contains("required");
    }
}
